...
class Program
{
    private static int _workTime = 30 * 60; // 25 minutes in seconds
    ...
    private static string _tickFile = new FileInfo("./sounds/s_tick.mp3").FullName;
    private static string _workEndFile = new FileInfo("./sounds/s_pom_alarm.mp3").FullName;
    private static string _breakEndFile = new FileInfo("./sounds/s_break_alarm.mp3").FullName;
    ...
    static async Task Main(string[] args)
    {
        ...
        while (true)
        {
            ...
            Console.ReadLine();
            await StartTimer(_workTime, "Work for 30 minutes.", true, false);
